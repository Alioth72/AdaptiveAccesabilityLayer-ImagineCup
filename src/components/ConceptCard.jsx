...
export default function ConceptCard({ concept, level, bionicMode }) {
    ...
    const speak = () => {
        ...
        // Speak simpler text if in remedial mode? Or just standard.
        const text = level === 'remedial' && concept.additionalVisual
    ...
    return (
        ...
        ${level === 'advanced' ? 'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500' : 'bg-gradient-to-r from-indigo-500 to-cyan-500'}
      `} />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    ...
                    {/* Show extra visual help if in Remedial Mode or Standard Mode (as optional) */}
                    {(level === 'remedial' || level === 'standard') && concept.additionalVisual && (
                        ...
                        >
                            ...
                            <div>
                                <h4 className="font-bold text-yellow-800 text-sm uppercase tracking-wide mb-1">Visual Analogy</h4>
