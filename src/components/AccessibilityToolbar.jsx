...
import { Settings, X, Type, Sun, Moon, MoveHorizontal, Baseline, BookOpen, Eye, Activity, Volume2, Palette, Zap } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export default function AccessibilityToolbar({ settings, updateSettings }) {
                    ...
                    >
                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                {/* Color Blindness Filters (Simulated with CSS) */}
                                <div className="mt-4">
...
function ThemeBtn({ name, active, onClick, color }) {
    return (
        <button
            onClick={onClick}
